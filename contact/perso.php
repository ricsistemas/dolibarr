...
if ($_GET["action"] == 'edit')
{
	...
	// Name
    print '<tr><td width="10%">'.$langs->trans("Lastname").'</td><td width="20%">'.$contact->nom.'</td>';
    print '<td width="10%">'.$langs->trans("Firstname").'</td><td width="40%">'.$contact->prenom.'</td>';
...
else
{
	...
	// Name
    print '<tr><td width="12%">'.$langs->trans("Lastname").'</td><td width="40%"><b>'.$contact->name.'</b></td>';
    print '<td width="10%">'.$langs->trans("Firstname").'</td><td width="40%"><b>'.$contact->firstname.'</b></td></tr>';
