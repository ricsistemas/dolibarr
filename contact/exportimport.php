...
print '<td width="12%">'.$langs->trans("Firstname").'</td><td width="40%"><b>'.$contact->firstname.'</b></td></tr>';
...
if ($contact->socid > 0)
{
	...
	print '<tr><td width="12%">'.$langs->trans("Company").'</td><td colspan="3">'.$objsoc->getNomUrl(1).'</td></tr>';
}
else
{
	print '<tr><td width="12%">'.$langs->trans("Company").'</td><td colspan="3">';
