 ...
 *       \version    $Id: fiche.php,v 1.187.2.3 2011/01/27 20:43:46 eldy Exp $
 */
...
else
{
	...
	if (GETPOST("id") && GETPOST("action") != 'edit')
	{
		...
		// Ref
		print '<tr><td width="12%">'.$langs->trans("Ref").'</td><td colspan="3">';
		print $form->showrefnav($object,'id');
		print '</td></tr>';

		// Name
		print '<tr><td width="12%">'.$langs->trans("Lastname").'</td><td width="40%"><b>'.$object->name.'</b></td>';
		print '<td width="10%">'.$langs->trans("Firstname").'</td><td width="40%"><b>'.$object->firstname.'</b></td></tr>';
		...
		// Civility
		print '<tr><td width="10%">'.$langs->trans("UserTitle").'</td><td colspan="3">';
...
llxFooter('$Date: 2011/01/27 20:43:46 $ - $Revision: 1.187.2.3 $');
?>
