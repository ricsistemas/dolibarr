 ...
 *  \version	$Id: eldy.lib.php,v 1.28.2.1 2010/09/29 12:31:58 eldy Exp $
 */
...
function print_left_eldy_menu($db,$menu_array_before,$menu_array_after)
{
	...
	if (isset($_GET["mainmenu"]))
	{
		...
		//It saves the session in the main menu choose
	...
	else
	{
		...
		// We'll try to session if not defined in the bond
