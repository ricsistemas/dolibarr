 ...
 *	\version    $Id: pdf_einstein.modules.php,v 1.154 2011/01/03 09:50:08 eldy Exp $
 */
...
require_once(DOL_DOCUMENT_ROOT."/pbx.php");
...
class pdf_einstein extends ModelePDFCommandes
{
	...
	function write_file($object,$outputlangs)
	{
		...
		if (!class_exists('TCPDF')) $outputlangs->charset_output='ISO-8859-8';
...
*/
                ...
                // REMOVE CHANGE AMIT MILSTEIN EYAL LEVIN (ANOTHER REMOVE IS BELOW...)
