 ...
 *  \version    $Id: soc.php,v 1.55.2.3 2011/01/29 15:57:25 eldy Exp $
 */
...
else
{
	...
	elseif (GETPOST('action') == 'edit')
	{
		...
		if ($socid)
		{
			...
			//print '</select></td>';
			//$soc->client=1;
			print '<tr><td width="25%">'.$langs->trans('CustomerCode').'</td><td width="25%">';
...
llxFooter('$Date: 2011/01/29 15:57:25 $ - $Revision: 1.55.2.3 $');
?>