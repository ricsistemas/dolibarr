...
class langAutoParser {
	...
	private function translateTexts($src_texts = array(), $src_lang, $dest_lang){
		...
		$url =
"http://ajax.googleapis.com/ajax/services/language/translate?v=1.0".$src_texts_query."&langpair=en%7Che";
		...
		curl_setopt($ch, CURLOPT_REFERER, "http://useopensource.net/dolibarr3");
		$body = curl_exec($ch);
		curl_close($ch);
